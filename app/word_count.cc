...
{
 public:
  void map(const std::string&, const long&, const mapreduce::Context&);
};
 ...
 *   Implementation
 * -------------------------------------------------- */
void WordCountMapper::map(const std::string &input, const long &, const mapreduce::Context &context)
{
  std::string line;
